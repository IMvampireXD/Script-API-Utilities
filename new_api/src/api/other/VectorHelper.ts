...
export class Vector3Helper {
     ...
     */
    public static equals(v1: {x: number, y: number, z: number}, v2: {x: number, y: number, z: number}): boolean {
     ...
     */
    public static add(v1: {x: number, y: number, z: number}, v2: {x?: number, y?: number, z?: number}): {x: number, y: number, z: number} {
        return { 
            x: v1.x + (v2.x ?? 0), 
            y: v1.y + (v2.y ?? 0), 
            z: v1.z + (v2.z ?? 0) 
     ...
     * @returns New vector result
     */
    public static subtract(v1: {x: number, y: number, z: number}, v2: {x?: number, y?: number, z?: number}): {x: number, y: number, z: number} {
        return { 
            x: v1.x - (v2.x ?? 0), 
            y: v1.y - (v2.y ?? 0), 
            z: v1.z - (v2.z ?? 0) 
     ...
     */
    public static scale(v1: {x: number, y: number, z: number}, scale: number): {x: number, y: number, z: number} {
        return { 
            x: v1.x * scale, 
            y: v1.y * scale, 
            z: v1.z * scale 
     ...
     * @returns Dot product result
     */
    public static dot(a: {x: number, y: number, z: number}, b: {x: number, y: number, z: number}): number {
     ...
     * @returns New vector result
     */
    public static cross(a: {x: number, y: number, z: number}, b: {x: number, y: number, z: number}): {x: number, y: number, z: number} {
        return {
            x: a.y * b.z - a.z * b.y,
            y: a.z * b.x - a.x * b.z,
            z: a.x * b.y - a.y * b.x
     ...
     */
    public static distance(a: {x: number, y: number, z: number}, b: {x: number, y: number, z: number}): number {
     ...
     */
    public static normalize(v: {x: number, y: number, z: number}): {x: number, y: number, z: number} {
     ...
     * @returns Formatted string
     */
    public static toString(v: {x: number, y: number, z: number}, options?: {decimals?: number, delimiter?: string}): string {
     ...
     */
    public static clamp(v: {x: number, y: number, z: number}, limits?: {
        min?: {x?: number, y?: number, z?: number}, 
        max?: {x?: number, y?: number, z?: number}
    }): {x: number, y: number, z: number} {
        return {
            x: MathHelper.clampNumber(v.x, limits?.min?.x ?? Number.MIN_SAFE_INTEGER, limits?.max?.x ?? Number.MAX_SAFE_INTEGER),
            y: MathHelper.clampNumber(v.y, limits?.min?.y ?? Number.MIN_SAFE_INTEGER, limits?.max?.y ?? Number.MAX_SAFE_INTEGER),
            z: MathHelper.clampNumber(v.z, limits?.min?.z ?? Number.MIN_SAFE_INTEGER, limits?.max?.z ?? Number.MAX_SAFE_INTEGER)
        };
    }
     ...
     */
    public static lerp(a: {x: number, y: number, z: number}, b: {x: number, y: number, z: number}, t: number): {x: number, y: number, z: number} {
        return {
            x: a.x + (b.x - a.x) * t,
            y: a.y + (b.y - a.y) * t,
            z: a.z + (b.z - a.z) * t
     ...
     * @returns New interpolated vector
     */
    public static slerp(a: {x: number, y: number, z: number}, b: {x: number, y: number, z: number}, t: number): {x: number, y: number, z: number} {
     ...
     * @returns New vector result
     */
    public static multiply(a: {x: number, y: number, z: number}, b: {x: number, y: number, z: number}): {x: number, y: number, z: number} {
        return {
            x: a.x * b.x,
            y: a.y * b.y,
            z: a.z * b.z
     ...
     */
    public static rotateX(v: {x: number, y: number, z: number}, a: number): {x: number, y: number, z: number} {
     ...
     * @returns New rotated vector
     */
    public static rotateY(v: {x: number, y: number, z: number}, a: number): {x: number, y: number, z: number} {
        const cos = Math.cos(a);
        const sin = Math.sin(a);
        return {
            x: v.x * cos + v.z * sin,
     ...
     * @returns New rotated vector
     */
    public static rotateZ(v: {x: number, y: number, z: number}, a: number): {x: number, y: number, z: number} {
        const cos = Math.cos(a);
        const sin = Math.sin(a);
        return {
            x: v.x * cos - v.y * sin,
...
export class Vector2Helper {
     ...
     * @returns Formatted string
     */
    public static toString(v: {x: number, y: number}, options?: {decimals?: number, delimiter?: string}): string {
        const decimals = options?.decimals ?? 2;
        const str = [
            v.x.toFixed(decimals), 
            v.y.toFixed(decimals)
