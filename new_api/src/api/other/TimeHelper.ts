...
export class TimeHelper {
     ...
     */
    public static setIntervalTicks(callback: () => void, intervalTicks: number): { dispose: () => void } {
     ...
     * @returns An object with a dispose method to cancel the timer.
     */
    public static setIntervalSeconds(callback: () => void, intervalSeconds: number): { dispose: () => void } {
     ...
     * @returns An object with a dispose method to cancel the timer.
     */
    public static setTimeoutSeconds(callback: () => void, delaySeconds: number): { dispose: () => void } {
