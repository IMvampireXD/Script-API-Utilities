...
export class DimensionHelper {
	 ...
	 * 
	 * DimensionHelper.spawnItem(dimension, "minecraft:diamond", location, 64);
	 * 
	 */
	 ...
	 *   const biomeId = await DimensionHelper.getBiome(player.location,player.dimension)
	...
	static async getBiome(location, dimension) {
		...
		if (!biomeTypes) throw Error("DimensionHelper.getDimension() Requires Beta API!")
