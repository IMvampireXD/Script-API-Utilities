...
export class BlockHelper {
	 ...
	 * breakBlocks(block, 5, 5, 5, "stone"); // Fills a 5x5x5 cube with stone
	 */
	static breakBlocks(startBlock, volumeWidth = 3, volumeHeight = 3, volumeDepth = 3, replacementBlockType = 'air') {
		const {
